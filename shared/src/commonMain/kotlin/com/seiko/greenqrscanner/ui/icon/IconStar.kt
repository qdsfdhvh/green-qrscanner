    ...
    return remember {
        ImageVector.Builder(
            ...
            path(
                ...
                moveToRelative(323.0f, 755.0f)
                lineToRelative(157.0f, -94.0f)
                lineToRelative(157.0f, 95.0f)
                lineToRelative(-42.0f, -178.0f)
                lineToRelative(138.0f, -120.0f)
                lineToRelative(-182.0f, -16.0f)
                lineToRelative(-71.0f, -168.0f)
                lineToRelative(-71.0f, 167.0f)
                lineToRelative(-182.0f, 16.0f)
                lineToRelative(138.0f, 120.0f)
                lineToRelative(-42.0f, 178.0f)
                close()
