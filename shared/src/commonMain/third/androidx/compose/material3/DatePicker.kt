...
fun DatePicker(
    ...
    val calendarModel = remember { createCalendarModel(defaultLocale) }
    DateEntryContainer(
        modifier = modifier,
        title = title,
        headline = headline,
...
object DatePickerDefaults {
    ...
    fun colors(
        ...
        dateTextFieldColors: TextFieldColors = TextFieldDefaults.outlinedTextFieldColors(), // OutlinedTextFieldDefaults.colors()
    ): DatePickerColors =
        DatePickerColors(
    ...
    fun DatePickerTitle(displayMode: DisplayMode, modifier: Modifier = Modifier) {
        when (displayMode) {
            DisplayMode.Picker -> Text(
                text = getString2(string = Strings2.DatePickerTitle),
                modifier = modifier,
            )

            DisplayMode.Input -> Text(
                text = getString2(string = Strings2.DateInputTitle),
                modifier = modifier,
            )
        }
    }
    ...
    fun DatePickerHeadline(
        ...
        val verboseDateDescription = dateFormatter.formatDate(
            ...
            DisplayMode.Picker -> getString2(Strings2.DatePickerNoSelectionDescription)
            DisplayMode.Input -> getString2(Strings2.DateInputNoInputDescription)
            else -> ""
        }

        val headlineText = formattedDate ?: when (displayMode) {
            DisplayMode.Picker -> getString2(Strings2.DatePickerHeadline)
            DisplayMode.Input -> getString2(Strings2.DateInputHeadline)
            else -> ""
        }

        val headlineDescription = when (displayMode) {
            DisplayMode.Picker -> getString2(Strings2.DatePickerHeadlineDescription)
            DisplayMode.Input -> getString2(Strings2.DateInputHeadlineDescription)
            else -> ""
        }.formatString(verboseDateDescription)
    ...
    if (displayMode == DisplayMode.Picker) {
        IconButton(onClick = { onDisplayModeChange(DisplayMode.Input) }, modifier = modifier) {
            Icon(
                ...
                contentDescription = getString2(Strings2.DatePickerSwitchToInputMode),
            )
        }
    } else {
        IconButton(onClick = { onDisplayModeChange(DisplayMode.Picker) }, modifier = modifier) {
            Icon(
                ...
                contentDescription = getString2(Strings2.DatePickerSwitchToCalendarMode),
            )
        }
    }
}
...
internal fun DatePickerHeader(
    ...
    Column(
        ...
        CompositionLocalProvider(
            LocalContentColor provides headlineContentColor,
            content = content,
        )
    }
}
    ...
    if (rangeSelectionEnabled) {
        when {
            isStartDate -> descriptionBuilder.append(
                getString2(string = Strings2.DateRangePickerStartHeadline),
            )

            isEndDate -> descriptionBuilder.append(
                getString2(string = Strings2.DateRangePickerEndHeadline),
            )

            isInRange -> descriptionBuilder.append(
                getString2(string = Strings2.DateRangePickerDayInRange),
            )
        }
    }
    if (isToday) {
        if (descriptionBuilder.isNotEmpty()) descriptionBuilder.append(", ")
        descriptionBuilder.append(getString2(string = Strings2.DatePickerTodayDescription))
    }
...
private fun YearPicker(
    ...
    ProvideTextStyle(
        ...
        val lazyGridState =
            rememberLazyGridState(
                ...
                initialFirstVisibleItemIndex = max(
                    0,
                    displayedYear - yearRange.first - YearsInRow,
                ),
            )
        ...
        val coroutineScope = rememberCoroutineScope()
        val scrollToEarlierYearsLabel = getString2(Strings2.DatePickerScrollToShowEarlierYears)
        val scrollToLaterYearsLabel = getString2(Strings2.DatePickerScrollToShowLaterYears)
        LazyVerticalGrid(
            ...
            items(yearRange.count()) {
                ...
                Year(
                    ...
                    description = getString2(Strings2.DatePickerNavigateToYearDescription)
                        .formatString(localizedYear),
                    colors = colors,
                ) {
                    Text(
                        text = localizedYear,
                ...
                Row {
                    ...
                    IconButton(onClick = onPreviousClicked, enabled = previousAvailable) {
                        Icon(
                            ...
                            contentDescription = getString2(Strings2.DatePickerSwitchToPreviousMonth),
                        )
                    }
                    IconButton(onClick = onNextClicked, enabled = nextAvailable) {
                        Icon(
                            ...
                            contentDescription = getString2(Strings2.DatePickerSwitchToNextMonth),
                        )
                    }
                }
            }
    ...
    TextButton(
        ...
        Icon(
            ...
            contentDescription = if (expanded) {
                getString2(Strings2.DatePickerSwitchToDaySelection)
            } else {
                getString2(Strings2.DatePickerSwitchToYearSelection)
            },
