...
object DateRangePickerDefaults {
    ...
    fun DateRangePickerTitle(displayMode: DisplayMode, modifier: Modifier = Modifier) {
        when (displayMode) {
            DisplayMode.Picker -> Text(
                getString2(string = Strings2.DateRangePickerTitle),
                modifier = modifier,
            )

            DisplayMode.Input -> Text(
                getString2(string = Strings2.DateRangeInputTitle),
                modifier = modifier,
            )
        }
    }
    ...
    fun DateRangePickerHeadline(
        ...
        val startDateText = getString2(Strings2.DateRangePickerStartHeadline)
        val endDateText = getString2(Strings2.DateRangePickerEndHeadline)
...
private class DateRangePickerStateImpl(
    ...
    override val selectedStartDateMillis: Long?
        @Suppress("AutoBoxing")
        get() = _selectedStartDate.value?.utcTimeMillis
    ...
    override val selectedEndDateMillis: Long?
        @Suppress("AutoBoxing")
        get() = _selectedEndDate.value?.utcTimeMillis
...
private fun VerticalMonthsList(
    ...
    ProvideTextStyle(
        ...
        val scrollToPreviousMonthLabel = getString2(Strings2.DateRangePickerScrollToShowPreviousMonth)
        val scrollToNextMonthLabel = getString2(Strings2.DateRangePickerScrollToShowNextMonth)
        LazyColumn(
