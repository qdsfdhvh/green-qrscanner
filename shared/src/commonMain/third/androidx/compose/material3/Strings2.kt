...
fun getString2(string: Strings2): String {
    return when (string) {
        ...
        Strings2.DatePickerNavigateToYearDescription -> "Navigate to year %1$"
        Strings2.DatePickerHeadlineDescription -> "Current selection: %1$"
        ...
        Strings2.DateInputHeadlineDescription -> "Entered date: %1$"
        Strings2.DateInputNoInputDescription -> "None"
        Strings2.DateInputInvalidNotAllowed -> "Date not allowed: %1$"
        Strings2.DateInputInvalidForPattern -> "Date does not match expected pattern: %1$"
        Strings2.DateInputInvalidYearRange -> "Date out of expected year range %1$ - %2$"
